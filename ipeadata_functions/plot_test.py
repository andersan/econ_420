...
# state renda
# graph(data.state_renda, "Income by state", "Year", "Per capita monthly family income (average)", "Estado")

# state ensino
# graph(data.state_ensino, "Years of schooling by state", "Year of census", "Years of schooling (average)", "Estado")

# state saude
# graph(data.state_saude, "Infant mortality", "Year", "Deaths per 1000 births", "Estado")
