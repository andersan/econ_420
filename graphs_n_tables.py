...
# state renda
functions.graph(data.state_renda, "Figure 2: Income by state", "Year", "Per capita monthly family income (average)", "Estado")

# state ensino
functions.graph(data.state_ensino, "Figure 3: Years of schooling by state", "Year of census", "Years of schooling (average)", "Estado")

# state saude
functions.graph(data.state_saude, "Figure 1: Infant mortality", "Year", "Deaths per 1000 births", "Estado")
